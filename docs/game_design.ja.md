...
|burning 炎上|バフ、デバフ|火属性の攻撃を受けると22%の確立で発生する。指定されたターンの間指定されたダメージを受ける。炎属性を持っているときに火属性の行動を起こすと、その行動の効果が2倍になるが、受ける炎上ダメージが1.5倍に増える。|
|frostbite 凍傷|バフ、デバフ|冷属性の攻撃を受けると22%の確立で発生する。指定されたターンの間指定されたダメージを受ける。冷属性を持っているときに冷属性の行動を起こすと、その行動の効果が2倍になるが、凍結する。炎上すると解除される。|
